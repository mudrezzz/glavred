...
В Slice 1.10.5 после утверждения текста пост показывает состояние `следующий шаг:
Визуал`. Полный экран визуального решения начинается в Slice 1.10.6: пользователь
готовит визуальный brief, выбирает/утверждает картинку или явно выбирает режим
`без визуала`. Только после утвержденного текста и визуального решения пост становится
`готов к выпуску`.
