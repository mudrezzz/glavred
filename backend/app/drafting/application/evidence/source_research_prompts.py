...
class SourceResearchPromptsComponent:
...
build_source_research_plan_messages = SourceResearchPromptsComponent.build_source_research_plan_messages
_json_like = SourceResearchPromptsComponent._json_like


__all__ = (
    'build_source_research_plan_messages',
    'SourceResearchPromptsComponent',
)
