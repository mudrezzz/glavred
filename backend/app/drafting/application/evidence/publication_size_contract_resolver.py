...
class PublicationSizeContractResolverPolicy:
...
_select_profile = PublicationSizeContractResolverPolicy._select_profile
_range = PublicationSizeContractResolverPolicy._range
_as_dict = PublicationSizeContractResolverPolicy._as_dict
_list_of_dicts = PublicationSizeContractResolverPolicy._list_of_dicts
_int = PublicationSizeContractResolverPolicy._int
_clamp = PublicationSizeContractResolverPolicy._clamp


__all__ = (
    'DEFAULT_PROFILE',
    'SIZE_MULTIPLIERS',
    'PublicationSizeContractResolver',
    'PublicationSizeContractResolverPolicy',
)
