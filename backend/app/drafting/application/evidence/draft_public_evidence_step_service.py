...
from backend.app.drafting.application.evidence.deterministic_external_evidence_synthesis_step_service import (
...
from backend.app.drafting.application.artifacts.source_ledger_budgeting import apply_external_claim_budget
from backend.app.drafting.application.evidence.source_ledger_external_evidence_merger import SourceLedgerExternalEvidenceMerger
