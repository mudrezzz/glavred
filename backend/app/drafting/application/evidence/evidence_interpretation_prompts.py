...
class EvidenceInterpretationPromptsComponent:
...
build_evidence_interpretation_messages = EvidenceInterpretationPromptsComponent.build_evidence_interpretation_messages
...
__all__ = (
    ...
    'EvidenceInterpretationPromptsComponent',
)
