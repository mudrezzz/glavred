...
class SourceLedgerSectionsComponent:
...
brief_claims = SourceLedgerSectionsComponent.brief_claims
candidate_claims = SourceLedgerSectionsComponent.candidate_claims
signal_claims = SourceLedgerSectionsComponent.signal_claims
topic_fabula_claims = SourceLedgerSectionsComponent.topic_fabula_claims
author_position_claims = SourceLedgerSectionsComponent.author_position_claims
risks = SourceLedgerSectionsComponent.risks
warnings = SourceLedgerSectionsComponent.warnings
base_forbidden_inferences = SourceLedgerSectionsComponent.base_forbidden_inferences
topic_forbidden_inferences = SourceLedgerSectionsComponent.topic_forbidden_inferences
constraint_claim = SourceLedgerSectionsComponent.constraint_claim
claim = SourceLedgerSectionsComponent.claim
warning = SourceLedgerSectionsComponent.warning
confidence_from_candidate = SourceLedgerSectionsComponent.confidence_from_candidate
confidence_from_author_evidence = SourceLedgerSectionsComponent.confidence_from_author_evidence
as_list = SourceLedgerSectionsComponent.as_list
...
__all__ = (
    ...
    'claim',
    'warning',
    'confidence_from_candidate',
    'confidence_from_author_evidence',
    'as_list',
    'SourceLedgerSectionsComponent',
)
