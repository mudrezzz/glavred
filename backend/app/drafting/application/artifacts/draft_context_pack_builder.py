...
class DraftContextPackBuilderComponent:
...
context_pack_for_role = DraftContextPackBuilderComponent.context_pack_for_role
_card_sort_key = DraftContextPackBuilderComponent._card_sort_key
...
__all__ = (
    ...
    'ROLE_REASONS',
    'ContextPackBuilder',
    'context_pack_for_role',
    'DraftContextPackBuilderComponent',
)
