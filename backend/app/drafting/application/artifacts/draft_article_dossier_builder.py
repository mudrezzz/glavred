...
from backend.app.drafting.application.evidence.evidence_interpretation_context_cards import evidence_interpretation_cards
...
class ArticleDossierBuilderComponent:
...
_ledger_cards = ArticleDossierBuilderComponent._ledger_cards
_public_evidence_cards = ArticleDossierBuilderComponent._public_evidence_cards
_contract_cards = ArticleDossierBuilderComponent._contract_cards
_rule_cards = ArticleDossierBuilderComponent._rule_cards
_material_cards = ArticleDossierBuilderComponent._material_cards
_strategy_cards = ArticleDossierBuilderComponent._strategy_cards
_rhetorical_cards = ArticleDossierBuilderComponent._rhetorical_cards
_draft_cards = ArticleDossierBuilderComponent._draft_cards
_validation_cards = ArticleDossierBuilderComponent._validation_cards
_dedupe = ArticleDossierBuilderComponent._dedupe
_records = ArticleDossierBuilderComponent._records
_record = ArticleDossierBuilderComponent._record
_strings = ArticleDossierBuilderComponent._strings
_str = ArticleDossierBuilderComponent._str
_priority = ArticleDossierBuilderComponent._priority
_severity_priority = ArticleDossierBuilderComponent._severity_priority


__all__ = (
    'MAX_DOSSIER_CARDS',
    'ArticleDossierBuilder',
    'ArticleDossierBuilderComponent',
)
