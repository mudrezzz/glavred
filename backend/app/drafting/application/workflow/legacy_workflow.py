...
Used by: DraftRunPipeline compatibility facade during behavior-preserving migration.
...
from backend.app.application.draft_article_memory_service import DraftArticleMemoryService
...
from backend.app.drafting.application.workflow.legacy_phase_builder import (
    LegacyDraftWorkflowPhaseBuilder,
)
...
def build_legacy_draft_workflow(
    *,
    ...
    services = LegacyDraftWorkflowServices.create(
    ...
    return DraftWorkflow(repository, LegacyDraftWorkflowPhaseBuilder(services).build_registry())
