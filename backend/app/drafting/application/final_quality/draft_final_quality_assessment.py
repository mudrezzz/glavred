...
from backend.app.drafting.application.final_quality.draft_final_quality_attribution import attribution_finding_split, effective_finding_counts, is_actionable_finding
...
class FinalQualityAssessmentPolicy:
    ...
    gate_payload = staticmethod(gate_payload)
    repair_instruction = staticmethod(repair_instruction)
    repair_rejection_reasons = staticmethod(repair_rejection_reasons)
    repair_goals = staticmethod(repair_goals)
    internal_jargon_leaks = staticmethod(internal_jargon_leaks)
    source_dump_risk = staticmethod(source_dump_risk)
    candidate_report = staticmethod(candidate_report)
    worst = staticmethod(worst)
