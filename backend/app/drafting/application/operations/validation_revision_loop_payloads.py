...
class ValidationRevisionLoopPayloadFactory:
    def __init__(self, revision_loop_policy: RevisionLoopPolicy | None = None) -> None:
        self._revision_loop_policy = revision_loop_policy or RevisionLoopPolicy()
    ...
    def revision_loop_report(
        ...
        *,
        ...
        return RevisionLoopReport(
            ...
            cycles=cycles,
            final_candidate_id=self._revision_loop_policy.candidate_id(current),
