...
class DraftModelRoleResolverComponent:
...
select_model_for_role = DraftModelRoleResolverComponent.select_model_for_role
unconfigured_model_selection = DraftModelRoleResolverComponent.unconfigured_model_selection
select_model_for_final_gate = DraftModelRoleResolverComponent.select_model_for_final_gate
selection_for_attempt = DraftModelRoleResolverComponent.selection_for_attempt
with_model_selection = DraftModelRoleResolverComponent.with_model_selection


__all__ = (
    'RECOMMENDED_MODEL_PORTFOLIO',
    'select_model_for_role',
    'unconfigured_model_selection',
    'select_model_for_final_gate',
    'selection_for_attempt',
    'with_model_selection',
    'DraftModelRoleResolverComponent',
)
