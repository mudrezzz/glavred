...
class ValidationEvidenceEvaluator:
    def __init__(
        self,
        *,
        attribution_resolver: AttributionRequirementResolver | None = None,
        marker_matcher: DraftAttributionMarkerMatcher | None = None,
    ) -> None:
        self._attribution_resolver = attribution_resolver or AttributionRequirementResolver()
    ...
    def findings(
        ...
        *,
        ...
        resolution = self._attribution_resolver.normalize(requirements, external_claims)
        ...
        if attribution_claims and _looks_like_public_claim(body):
            attribution = self._marker_matcher.evaluate(body=body, claims=external_claims, claim_ids=attribution_claims)
            attribution.update({
