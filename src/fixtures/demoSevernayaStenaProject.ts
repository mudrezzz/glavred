...
export const severnayaStenaBenchmarkSeed: BenchmarkWorkspaceSeed = {
  ...
  editorialModel: {
    author:
      'Практик коммерциализации сложных B2B-продуктов, который смотрит на продажи как на восхождение: нужен маршрут, связка, снаряжение и страховка.',
    audience:
    ...
    goals: [
      ...
      'Показать, что команда умеет быстро заходить в коммерческий хаос и превращать его в маршрут, CRM-дисциплину, материалы, ABM и аналитику.',
